...
dopragma (char *ln)
{
    ...
    {
        if (cflag)
            puts (";\n#2");             /* WZ - the addition of the semicolon assists c.comp from outputing asm prematurally */
        else
            printf (";\n#pragma asm "); /* WZ - the addition of the semicolon assists c.comp from outputing asm prematurally */
